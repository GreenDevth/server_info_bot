...
class RegistrationPlayers(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        if message.channel.id == 918381749833171005:
            ...
            if message.content.isdigit() and length == 17:
                ...
                await message.reply('SteamID64 only in this channel', mention_author=False, delete_after=5)
    ...
    async def get_rules(self, ctx):
        await ctx.channel.send(
            ...
            "\n\nเซิร์ฟเวอร์ที่ออกแบบมาให้ระบบการเล่นมีความแตกต่างจากเซิร์ฟทั่วไป\nโดยปรับแต่งค่าต่าง ๆ ให้มีความเป็นเกมส์เอาตัวรอดให้มากที่สุด\nปิดการสร้างตี้ ปิดการใช้งานกับดัก ปิดการแสดงแผนที่" +
            "\n\n⚖ **เงื่อนไขและข้อตกลง**" +
            "\nผู้เล่นต้องยอมรับในกฎกติกาของเซิร์ฟอย่างเคร่งครัด" +
            "\n- การสร้างธงอนุญาตให้สร้างได้เพียง 1 ธงต่อคน\n- สามารถสร้างบ้านได้ทุกที่ แต่ห้ามใช้บัคของเกมส์ในการก่อสร้าง เช่น รั้วและตัวบ้าน\n- สามารถครอบครองยานพาหนะได้ไม่จำกัด" +
    ...
    async def clear(self, ctx, amount: int):
        ...
        await ctx.send(f'**Delete {amount} Message successfull.**', delete_after=5)
